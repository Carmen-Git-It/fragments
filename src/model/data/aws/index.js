...
function writeFragment(fragment) {
  ...
  try {
    ...
    logger.warn({ e, params, fragment }, 'error writing fragment to DynamoDB');
    throw e;
  }
}
...
async function readFragment(ownerId, id) {
  ...
  try {
    ...
    logger.warn({ e, params }, 'error reading fragment from DynamoDB');
    throw e;
  }
}
...
async function listFragments(ownerId, expand = false) {
  ...
  try {
    ...
    logger.error({ e, params }, 'error getting all fragments for user from DynamoDB');
    throw e;
  }
}
